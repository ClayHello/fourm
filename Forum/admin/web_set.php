<?php
	...
	if(isset($_POST['submit'])){
		...
		$query="update info set title='{$_POST['title']}',keywords='{$_POST['keywords']}',description={$_POST['description']}";
		execute($link, $query);
	...
	<form action="" method="post">
		<table class="au">
				...
				<tr>
					<td>描述</td>
					<td>
						<textarea rows="100px" cols="200px" style="resize:none;" name="description"><?php echo $data_info['description']?></textarea>
					</td>
					<td>
						描述
					</td>
